<?php
	...
	if(file_exists($dir)) {
		...
		if(strpos($fileName, '.') > 1) {
			if(touch($dir)) {
				echo "<li><a href='root/" . $file . "'>" . $fileName . "</a>a class='input-name' href='$folder/$file'> $file </a><button id='editBtn'>Edit</button><button id='btnDelete' class='btnDelete'>Delete</button></li>";
